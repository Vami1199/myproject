...
Ext.onReady(function(){
	...
	Ext.define('PMonthrequest', {
		...
		//定义类的属性
		fields: [
		         {name: 'ahTime', type: 'date',dateFormat:'n/j h:i'},
		         {name: 'ahId', type: 'string'},
		         {name: 'ahStart' ,type: 'string'},
				 {name: 'ahNum',type:'string'},
				 {name: 'ahReceivetime', type: 'string'},
				 {name: 'ahIntime',type:'string'},
				 {name: 'ahWagonnum',type:'integer'},
				 {name: 'ahWeight',type:'Long'},	
		         {name: 'awType',type:'byte'},
				 {name: 'ahWeight',type:'Long'},	
				 {name: 'ahRoaduser',type:'string'},
		         {name: 'ahDispatcher',type:'string'},
		         {name: 'ahIsdepart',type:'byte'},
