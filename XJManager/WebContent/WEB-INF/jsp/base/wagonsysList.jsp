	...
	<form action="">
		<table class="table table-hover table-bordered">
			<tbody bgcolor="#428BCA">
				<tr>
					<td align=center><span style="font-weight: bold;">车皮类型</span></td>
					<td align=center><span style="font-weight: bold;">车皮编号信息</span></td>
					<td align=center><span style="font-weight: bold;">前缀位数</span></td>
