...
<body>
	...
	<div class="bs-docs-example">
		<div class="navbar">
			...
			<div align="center">
				<div>
				<h2 class="brand" ><font color="blue"　>客户信息管理</font></h2>
				</div>
			</div>
					<hr>
					<br>
					...
					<div>
						<a href="#" class="btn btn-primary"><i
							...
							class="btn btn-success"><i class="icon-plus icon-white"></i>新增</a>
							...
							<table class="table table-hover table-bordered">
								<tbody bgcolor="#428BCA">
									<tr>
										...
										<td align=center><span style="font-weight: bold;">客户编号</span></td>
										<td align=center><span style="font-weight: bold;">客户全称</span></td>
										<td align=center><span style="font-weight: bold;">客户简称</span></td>
										<td align=center><span style="font-weight: bold;">电煤标志</span></td>
										<td align=center><span style="font-weight: bold;">企业性质</span></td>
										<td align=center><span style="font-weight: bold;">客户类型</span></td>
										<td align=center><span style="font-weight: bold;">所属行业</span></td>
										<td align=center><span style="font-weight: bold;">部别</span></td>
										<td align=center><span style="font-weight: bold;">客户标志</span></td>
