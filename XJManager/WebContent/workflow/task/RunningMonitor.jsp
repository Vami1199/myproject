...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	...
	<head>
		...
		<script type="text/javascript">
		    var lang_tip_msg = "加载监控数据失败>>  传入待办ID或流程实例ID值为空, 请确认！"
		    if("<%=systemLanguage%>" != null && "en" == "<%=systemLanguage%>"){
		    	lang_tip_msg = "Fail to load monitoring data,cause of the error: either of parameter task id and parameter instance id of process is empty !";
		    }
			function chkId(){
				if("<%=varId%>" == ""){
