			...
			<div class="navbar-inner">
				<div class="container">
					<div align="center">
						<div>
							<h2 class="brand">
								<font color="blue"　>当前位置：维护煤样化验结果</font>
							</h2>
						</div>
					</div>
					<hr>
					...
					<div>
						<a href="#" class="btn btn-warning"><i
							class="icon-edit icon-white"></i>修改</a> <a href="#"
							class="btn btn-danger"><i class="icon-ok icon-white"></i>确认</a>
							...
							<table class="table table-hover table-bordered">
								<tbody bgcolor="#428BCA">
									<tr>
										...
										<td align=center><span style="font-weight: bold;">煤样编号</span></td>
										...
										<td align=center><span style="font-weight: bold;">采样地</span></td>
										<td align=center><span style="font-weight: bold;">生产单位</span></td>
										<td align=center><span style="font-weight: bold;">班次</span></td>
										<td align=center><span style="font-weight: bold;">主采煤层</span></td>
										<td align=center><span style="font-weight: bold;">收货单位</span></td>
										<td align=center><span style="font-weight: bold;">采样人</span></td>
										<td align=center><span style="font-weight: bold;">制样人</span></td>
										<td align=center><span style="font-weight: bold;">采样开始时间</span></td>
										<td align=center><span style="font-weight: bold;">采样结束时间</span></td>
										<td align=center><span style="font-weight: bold;">制样接样时间</span></td>
										<td align=center><span style="font-weight: bold;">制样结束时间</span></td>
										<td align=center><span style="font-weight: bold;">煤样标记</span></td>
