			...
			<div class="navbar-inner">
				<div class="container">
					<div align="center">
						<div>
							<h2 class="brand">
								<font color="blue"　>当前位置：维护发煤申请单</font>
							</h2>
						</div>
					</div>
					<hr>
					...
					<div>
						...
						<a href="#" class="btn btn-danger"><i
							...
							class="btn btn-info"><i class="icon-share icon-white"></i>送审</a>
						<a href="#" class="btn btn-primary"><i
							class="icon-pencil icon-white"></i>审批</a> <a href="#" class="btn"><i
							...
							<table class="table table-hover table-bordered">
								<tbody bgcolor="#428BCA">
									<tr>
										...
										<td align=center><span style="font-weight: bold;">收货地点</span></td>
										<td align=center><span style="font-weight: bold;">申请数量</span></td>
										<td align=center><span style="font-weight: bold;">订单结余量</span></td>
										<td align=center><span style="font-weight: bold;">矿别</span></td>
										<td align=center><span style="font-weight: bold;">发煤日期</span></td>
										<td align=center><span style="font-weight: bold;">单价</span></td>
										<td align=center><span style="font-weight: bold;">金额</span></td>
