			...
			<div class="navbar-inner">
				<div class="container">
					<div align="center">
						<div>
							<h2 class="brand">
								<font color="blue"　>当前位置：维护购煤申请单</font>
							</h2>
						</div>
					</div>
					<hr>
					...
					<div>
						<a href="#" class="btn btn-success"><i
							...
							class="btn btn-info"><i class="icon-star"></i>红冲</a>
					</div>
							...
							<table class="table table-hover table-bordered">
								<tbody bgcolor="#428BCA">
									<tr>
										...
										<td align=center><span style="font-weight: bold;">开票日期</span></td>
										<td align=center><span style="font-weight: bold;">客户名称</span></td>
										<td align=center><span style="font-weight: bold;">执行单位</span></td>
										<td align=center><span style="font-weight: bold;">承运方式</span></td>
										<td align=center><span style="font-weight: bold;">付款方式</span></td>
										<td align=center><span style="font-weight: bold;">总金额</span></td>
