			...
			<div class="navbar-inner">
				<div class="container">
					<div align="center">
						<div>
							<h2 class="brand">
								<font color="blue"　>当前位：查询商品煤发运记录</font>
							</h2>
						</div>
					</div>
					<hr>
							...
							<table width="100%" border="1" bgcolor="#F5F5F5"
								...
								<tbody bgcolor="#428BCA">
									<tr>
										...
										<td align=center><span style="font-weight: bold;">记录编号</span></td>
										...
										<td align=center><span style="font-weight: bold;">总发运量（吨）</span></td>
