			...
			<div class="navbar-inner">
				<div class="container">
					<div align="center">
						<div>
							<h2 class="brand">
								<font color="blue"　>当前位置：铁路核减月请车计划</font>
							</h2>
						</div>
					</div>
					<hr>
							...
							<table width="100%" border="1" bgcolor="#F5F5F5"
								...
								<tbody bgcolor="#428BCA">
									<tr>
										...
										<td align=center><span style="font-weight: bold;">实发车数</span></td>
										<td align=center><span style="font-weight: bold;">实发吨数</span></td>
