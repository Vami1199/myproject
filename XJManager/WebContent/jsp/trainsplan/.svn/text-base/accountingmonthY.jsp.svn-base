			...
			<div class="navbar-inner">
				<div class="container">
					<div align="center">
						<div>
							<h2 class="brand">
								<font color="blue"　>铁路核减月请车计划</font>
							</h2>
						</div>
					</div>
					<hr>
					...
					<div>
						<a href="#" class="btn btn-warning"><i
							...
							class="btn btn-danger"><i class="icon-ok icon-white"></i>确认</a> <a
							href="#" class="btn btn-success"><i
							class="icon-book icon-white"></i>浏览合同信息</a> <a href="#"
							class="btn btn-danger"><i class="icon-pencil icon-white"></i>审批意见</a>
						<a href="#" class="btn btn-info"><i
							class="icon-print icon-white"></i>打印</a> <a href="#" class="btn"><i
							...
							<table width="100%" border="1" bgcolor="#F5F5F5"
								...
								<tbody bgcolor="#428BCA">
									<tr>
										...
										<td align=center><span style="font-weight: bold;">确认车数</span></td>
										<td align=center><span style="font-weight: bold;">确认吨数</span></td>
