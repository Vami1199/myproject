			...
			<div class="navbar-inner">
				<div class="container">
					<div align="center">
						<div>
							<h2 class="brand">
								<font color="blue"　>当前位置：查询铁运日请车计划</font>
							</h2>
						</div>
					</div>
					<hr>
					...
					<div>
						<a href="#" class="btn btn-info"><i
							class="icon-print icon-white"></i>打印</a> <a href="#"
							class="btn btn-primary"><i class="icon-search icon-white"></i>筛选</a>
							...
							<table width="100%" border="1" bgcolor="#F5F5F5"
								...
								<tbody bgcolor="#428BCA">
									<tr>
										...
										<td align=center><span style="font-weight: bold;">调度员</span></td>
										<td align=center><span style="font-weight: bold;">审核人</span></td>
										<td align=center><span style="font-weight: bold;">发站</span></td>
										<td align=center><span style="font-weight: bold;">总请车数</span></td>
										<td align=center><span style="font-weight: bold;">总确认数</span></td>
										<td align=center><span style="font-weight: bold;">总实发车数</span></td>
										<td align=center><span style="font-weight: bold;">总运量</span></td>
