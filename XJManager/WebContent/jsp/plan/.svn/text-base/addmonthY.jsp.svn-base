			...
			<div class="navbar-inner">
				<div class="container">
					<div align="center">
						<div>
							<h2 class="brand">
								<font color="blue"　>当前位置：制定月度销售计划</font>
							</h2>
						</div>
					</div>
					<hr>
							...
							<table width="100%" border="1" bgcolor="#F5F5F5"
								...
								<tbody bgcolor="#428BCA">
									<tr>
										...
										<td align=center><span style="font-weight: bold;">月销售计划编号</span></td>
										<td align=center><span style="font-weight: bold;">年度</span></td>
										<td align=center><span style="font-weight: bold;">月份</span></td>
										<td align=center><span style="font-weight: bold;">制定机构</span></td>
										<td align=center><span style="font-weight: bold;">计划类型</span></td>
										<td align=center><span style="font-weight: bold;">运输方式</span></td>
										<td align=center><span style="font-weight: bold;">计划销量</span></td>
