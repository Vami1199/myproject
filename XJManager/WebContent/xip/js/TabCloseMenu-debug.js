	...
	onCollectFunctions : function(){
		try{
    		...
    		if(funTreeId=='indexPanel'){
    			//Ext.Msg.alert(XipLang.xwf_lang_notice,'首页不能收藏!');
    			return;
    		}
         	...
         	Ext.Ajax.request({
                ...
                success: function(response,options){
                	...
                	if(response.total==0){
                		...
                		isExistFlag = true;
                		Ext.Msg.alert(XipLang.xwf_lang_notice,XipLang.tab_close_duplicate_collect);
                	}
                },
                failure: function(response,options){
                	isExistFlag = true;
                	Ext.Msg.alert(XipLang.xwf_lang_notice,XipLang.xwf_lang_server_no_response);
                }
         	});
         	...
         	Ext.Ajax.request({
                ...
                success: function(response,options){
                	...
                	Ext.Msg.alert(XipLang.xwf_lang_notice,XipLang.tab_close_collect_success);
                },
                failure: function(response,options){
                	isExistFlag = true;
                	Ext.Msg.alert(XipLang.xwf_lang_notice,XipLang.xwf_lang_server_no_response);
