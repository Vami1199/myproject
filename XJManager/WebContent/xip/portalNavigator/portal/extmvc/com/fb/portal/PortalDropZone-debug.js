/**
 * 定义可拖拽行为，Ext的组件有dd属性，使用这个类可以给组件添加一些拖拽效果，
 * 实现wiget的可拖拽行为
 */
Ext.define("com.fb.portal.PortalDropZone", {
	extend : "Ext.dd.DropTarget",
	constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        com.fb.portal.PortalDropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        com.fb.portal.PortalDropZone.superclass.unreg.call(this);
    }
})